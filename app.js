...
wss.on('connection', (ws) => {
    ...
    ws.on('message', (message) => {
        ...
        //const py_process = spawn('pipenv run python3.7', ["examples/finnegans-wake-demo/api.py"]);
        const py_process = spawn('./run.sh');
        ...
        py_process.stdout.on('end', function(){
            ...
            ws.send(JSON.stringify({ time: messageServer.time, number: messageServer.number, resp: responce }));
        });
